...
void wave_monster(vector<Monster>* wave,int init_x, int init_y) {
    int number1 = rand() % 9;
    for (int i=0; i<10; i++){
            Monster monster1(init_x-30*i,init_y,MONSTER1,0,15,2,5,0.75,1,1,1.25);
            Monster monster2(init_x-30*i,init_y,MONSTER2,0,20,2,5,1.25,0.8,1,0.8);
        if (i<number1) {
