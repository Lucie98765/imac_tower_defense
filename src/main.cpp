...
int main(int argc, char const *argv[]) {
	...
	//for ( unsigned int j=1; j < (*newmap).get_TabNode().size(); j++) {
		...
		vector<Entity> path = newmap->get_path_pixel();
		cout << path.size();
		...
		Monster* monster = new Monster(0,0,MONSTER1,0,15,1,5,0.75,1,1,1.25);

		// int x1=node1.get_pos_x();
		// cout << node1.get_pos_x()<< "\n";
		// int y1=node1.get_pos_y();
		// cout << node1.get_pos_y() << "\n";
		// int x2=node2.get_pos_x();
		// cout << node2.get_pos_x() << "\n";
		// int y2=node2.get_pos_y();
		// cout << node2.get_pos_y() << "\n";

		// monster->move(x1, y1, x2, y2);
