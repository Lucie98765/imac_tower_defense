...
// bool path_enter_exit(vector<Node> nodeList) {
//     for (int i=0 < nodeList.size(); i++) {
//         if (nodeList[i].get_type==1){
//           for (int j=0;j<nodeList[i].get_linked_points().size(); j++) {
//             if ( (nodeList[i].get_linked_points())[i].type == )
//           }
//         }
//       }
//     }
